...
# source ~/.colors.sh
source ~/.dotfiles/home/.colorss.sh
...
typeset -g POWERLEVEL9K_INSTANT_PROMPT=quiet
  ...
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_GAP_BACKGROUND=$transparent
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=red
...
'builtin' 'unset' 'p10k_config_optst'
